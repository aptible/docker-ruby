...
* `latest`: Currently Ruby 2.6.4 (don't depend on this tag: it will change over time).
...
* `2.4-ubuntu-16.04`   (aliased as `2.4`):   Ruby 2.4.7
* `2.5-ubuntu-16.04`   (aliased as `2.5`):   Ruby 2.5.6
* `2.6-ubuntu-16.04`   (aliased as `2.6`):   Ruby 2.6.4
